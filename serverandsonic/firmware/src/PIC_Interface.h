...
typedef enum
{
	...
	PIC_INTERFACE_STATE_INIT=0,
	PIC_INTERFACE_STATE_SERVICE_TASKS,

	/* TODO: Define states used by the application state machine. */

} PIC_INTERFACE_STATES;

extern uint8_t robot_x;
extern uint8_t robot_y;
extern int16_t robot_theta;
