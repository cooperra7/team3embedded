...
void DRV_OC0_Initialize(void)
{
    ...
    PLIB_OC_Buffer16BitSet(OC_ID_2, 3000);
    PLIB_OC_PulseWidth16BitSet(OC_ID_2, 15);
    OC2R = 30000;
    OC2RS = 30020;
}
...
{
    /* Setup OC0 Instance */
    PLIB_OC_ModeSelect(OC_ID_5, OC_DUAL_COMPARE_CONTINUOUS_PULSE_MODE);
    PLIB_OC_BufferSizeSelect(OC_ID_5, OC_BUFFER_SIZE_16BIT);
    PLIB_OC_TimerSelect(OC_ID_5, OC_TIMER_16BIT_TMR2);
    PLIB_OC_Buffer16BitSet(OC_ID_5, 3000);
    PLIB_OC_PulseWidth16BitSet(OC_ID_5, 15);
    OC5R = 30000;
    OC5RS = 30020;
}
...
void DRV_OC2_Initialize(void)
{
    ...
    PLIB_OC_PulseWidth16BitSet(OC_ID_3, 15);
    OC3R = 30000;
    OC3RS = 30020;
}
...
{
    /* Setup OC0 Instance */
    PLIB_OC_ModeSelect(OC_ID_4, OC_DUAL_COMPARE_CONTINUOUS_PULSE_MODE);
    PLIB_OC_BufferSizeSelect(OC_ID_4, OC_BUFFER_SIZE_16BIT);
    PLIB_OC_TimerSelect(OC_ID_4, OC_TIMER_16BIT_TMR2);
    PLIB_OC_Buffer16BitSet(OC_ID_4, 3000);
    PLIB_OC_PulseWidth16BitSet(OC_ID_4, 15);
    OC4R = 30000;
    OC4RS = 30020;
}
