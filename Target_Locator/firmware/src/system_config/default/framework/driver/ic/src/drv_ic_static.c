...
{	
    ...
    PLIB_IC_EventsPerInterruptSelect(IC_ID_3, IC_INTERRUPT_ON_EVERY_2ND_CAPTURE_EVENT);   
...
void DRV_IC1_Open(void)
{
}

void DRV_IC1_Close(void)
{
}
...
{	
    PLIB_IC_ModeSelect(IC_ID_4, IC_INPUT_CAPTURE_EDGE_DETECT_MODE);
    ...
    PLIB_IC_EventsPerInterruptSelect(IC_ID_4, IC_INTERRUPT_ON_EVERY_2ND_CAPTURE_EVENT);   
...
void DRV_IC2_Open(void)
{
}

void DRV_IC2_Close(void)
{
}
uint32_t DRV_IC2_Capture32BitDataRead(void)
{
   return PLIB_IC_Buffer32BitGet(IC_ID_4);
}

uint16_t DRV_IC2_Capture16BitDataRead(void)
{
   return PLIB_IC_Buffer16BitGet(IC_ID_4);
}

bool DRV_IC2_BufferIsEmpty(void)
{
...
{	
    PLIB_IC_ModeSelect(IC_ID_5, IC_INPUT_CAPTURE_EDGE_DETECT_MODE);
    ...
    PLIB_IC_EventsPerInterruptSelect(IC_ID_5, IC_INTERRUPT_ON_EVERY_2ND_CAPTURE_EVENT);   
...
void DRV_IC3_Start(void)
{
   PLIB_IC_Enable(IC_ID_5);
}

void DRV_IC3_Stop(void)
{
   PLIB_IC_Disable(IC_ID_5);
}

void DRV_IC3_Open(void)
{
}

void DRV_IC3_Close(void)
{
}
uint32_t DRV_IC3_Capture32BitDataRead(void)
{
   return PLIB_IC_Buffer32BitGet(IC_ID_5);
}

uint16_t DRV_IC3_Capture16BitDataRead(void)
{
   return PLIB_IC_Buffer16BitGet(IC_ID_5);
}

bool DRV_IC3_BufferIsEmpty(void)
{
